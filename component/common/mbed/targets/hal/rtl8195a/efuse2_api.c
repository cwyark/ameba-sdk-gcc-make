...
extern VOID  ReadEfuseContant2(OUT u8 *pContant);
extern u8 WriteEfuseContant2(IN u8 CodeWordNum, IN u8 WordEnable, IN u8 *pContant);
...
{
    return WriteEfuseContant2(codewordnum,worden,data);
}
#endif
